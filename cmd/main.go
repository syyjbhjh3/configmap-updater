...
import (
	...
	"github.com/syyjbhjh3/configmap-updater/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "b328d485.ops.example.io",
	...
	if err := (&controller.ConfigMapUpdaterReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ConfigMapUpdater")
		os.Exit(1)
	}
